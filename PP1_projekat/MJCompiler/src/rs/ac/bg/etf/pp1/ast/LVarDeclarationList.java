...
public class LVarDeclarationList extends VarDeclList {

    private VarDeclaration VarDeclaration;
    private VarDeclList VarDeclList;

    public LVarDeclarationList (VarDeclaration VarDeclaration, VarDeclList VarDeclList) {
    ...
    public String toString(String tab) {
        ...
        buffer.append(tab);
        buffer.append("LVarDeclarationList(\n");
