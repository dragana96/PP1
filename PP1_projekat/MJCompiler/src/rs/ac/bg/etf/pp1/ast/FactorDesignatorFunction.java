...
public class FactorDesignatorFunction extends Factor {

    private Designator Designator;
    private CallParamList CallParamList;

    public FactorDesignatorFunction (Designator Designator, CallParamList CallParamList) {
    ...
    public String toString(String tab) {
        ...
        buffer.append(tab);
        buffer.append("FactorDesignatorFunction(\n");
