...
public class ErrorIfUnmatched1 extends Unmatched {

    private ErrorIf ErrorIf;
    private Matched Matched;
    private Unmatched Unmatched;

    public ErrorIfUnmatched1 (ErrorIf ErrorIf, Matched Matched, Unmatched Unmatched) {
    ...
    public String toString(String tab) {
        ...
        buffer.append(tab);
        buffer.append("ErrorIfUnmatched1(\n");
