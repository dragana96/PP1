...
//factor designator
	...
	public void visit(DesignatorValue design) {
		...
		if (DessignatorAssign.class != parent.getClass() && DesignatorMethodCall.class != parent.getClass()
				&& FactorDesignatorFunction.class != parent.getClass() && ReadStatement.class != parent.getClass() && design.obj.getKind() != Obj.Type) {
	...
	public void visit(EnumWithValue enumNum) {
		...
		//System.out.println("tipEWV =" + obj.getType().toString());
		Code.load(obj);
	}
