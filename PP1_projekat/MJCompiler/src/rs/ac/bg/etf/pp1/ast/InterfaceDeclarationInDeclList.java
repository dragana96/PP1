...
public class InterfaceDeclarationInDeclList extends Decl {

    private InterfaceDecl InterfaceDecl;

    public InterfaceDeclarationInDeclList (InterfaceDecl InterfaceDecl) {
    ...
    public String toString(String tab) {
        ...
        buffer.append(tab);
        buffer.append("InterfaceDeclarationInDeclList(\n");
